...
//      double theta = rotDeadband.apply(-controller.getRawAxis(2));
		...
		// Xbox controller
//		double x = xyDeadband.apply(-controller.getRightX());
//		double y = xyDeadband.apply(-controller.getRightY());
//		double theta = rotDeadband.apply(-controller.getLeftX());

		// Keyboard
		double x = xyDeadband.apply(-controller.getRawAxis(1));
		double y = xyDeadband.apply(-controller.getRawAxis(2));
		double theta = rotDeadband.apply(-controller.getRawAxis(3));
